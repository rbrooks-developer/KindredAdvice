      ...
      <div className="w-full max-w-sm space-y-8">
        <div className="text-center space-y-2">
          <div className="flex justify-center">
            <Heart className="w-10 h-10 fill-primary stroke-primary" />
          </div>
          <h1 className="text-2xl font-bold">Welcome back</h1>
          <p className="text-sm text-muted-foreground">Sign in to your KindredAdvice account</p>
        </div>
        ...
        <p className="text-center text-sm text-muted-foreground">
          ...
          <Link href="/signup" className="text-primary hover:underline font-medium">Join KindredAdvice</Link>
        </p>
      </div>
    </div>
  )
